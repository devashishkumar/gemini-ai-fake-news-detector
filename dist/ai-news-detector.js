 ...
 */
function detectFakeNewsFromURL(url) {
    return __awaiter(this, void 0, void 0, function () {
        var html, $, articleText, trimmedText, apiKey, ai, model, prompt, result, responseText;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    trimmedText = articleText.substring(0, 12000);
...
(function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, detectFakeNewsFromURL(url)];
            case 2:
                res = _a.sent();
